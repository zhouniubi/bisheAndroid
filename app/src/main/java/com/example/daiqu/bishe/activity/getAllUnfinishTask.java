...
public class getAllUnfinishTask extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_all_unfinish_task);
        ActivityCollector.addActivity(this);
        initWidget();
    }
    private void initWidget(){
        phone = taskFragment.phone;
        postTaskList = findViewById(R.id.postTaskList2);
        textView = findViewById(R.id.show_no_msg2);
        title_paixu = findViewById(R.id.title_paixu2);
    }
    ...
    protected void onStart() {
        ...
        new Thread(() -> {
            ...
            //设置选择00状态
            map.put("state", "00");
            String data = HttpUtils.sendPostMessage(map, "UTF-8", "findTaskByState");
            Log.d("DATA是", data);
            if (data.equals("-999")) {
                Looper.prepare();
                ...
                if (getPerference().equals("null")) {
                    ...
                    runOnUiThread(() -> {
                        ...
                        PostTaskListViewAdapter adapter = new PostTaskListViewAdapter(this, R.id.postTaskList2, R.layout.list_item_layout2, list);
        ...
        postTaskList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(this,showUnfinishTaskInformation.class);
    ...
    private void postPreference(String data) {
        SharedPreferences sharedPreferences = this.getSharedPreferences("postTaskUnfinish", 0);
